...
public class StartupDataProd implements CommandLineRunner {
    ...
    private LessonOrder initLessonOrder() {
        ...
        switch (lesson) {
            case 1:
                return LessonOrder.FIRST;
            case 2:
                return LessonOrder.SECOND;
            case 3:
                return LessonOrder.THIRD;
            case 4:
                return LessonOrder.FORTH;
            case 5:
                return LessonOrder.FIFTH;
            case 6:
                return LessonOrder.SIXTH;
            case 7:
                return LessonOrder.SEVENTH;
        }
        return LessonOrder.SEVENTH;
    }
